...
/**@brief esCuit(): Verifica si la cadena/buffer son solo caracteres validos para el cuit.
...
/**@brief strupr(): Convierte toda la cadena en mayuscula (Para Linux).
...
/**@brief strlwr(): Convierte toda la cadena en minuscula (Para Linux).
 * @param char* cadena, es la cadena a utilizar.
 */
